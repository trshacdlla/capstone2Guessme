...
public class MathStatisticsB2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_statistics_b2);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.MTB2barchart);
        back=(Button) findViewById(R.id.MTB2back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(MathStatisticsB2.this);

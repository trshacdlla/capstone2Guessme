...
public class ScienceStatisticsI4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_i4);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STI4barchart);
        back=(Button) findViewById(R.id.STI4back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsI4.this);

...
public class ScienceB1 extends AppCompatActivity {
...
//        startTimer();
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.sb1question);
        timer = (TextView) findViewById(R.id.sb1Timer);
        score = (TextView) findViewById(R.id.sb1score);
        questionNumber = (TextView) findViewById(R.id.sb1questionNumber);

        ans1 = (Button) findViewById(R.id.sb1ans1);
        ans2 = (Button) findViewById(R.id.sb1ans2);
        ans3 = (Button) findViewById(R.id.sb1ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScoreB1.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getS1G1Questions(randomnum));
        ans1.setText(Questions.getS1G1Choice1(randomnum));
        ans2.setText(Questions.getS1G1Choice2(randomnum));
        ans3.setText(Questions.getS1G1Choice3(randomnum));

        Answer = Questions.getS1G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        String ins = "Choose the answer that best fits the sentence.";

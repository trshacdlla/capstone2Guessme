...
public class TechStatistics5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_statistics5);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.TT5barchart);
        back=(Button) findViewById(R.id.TT5back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(TechStatistics5.this);
        level1 = mPref.getString("Tech1Score", " ");
        level2 = mPref.getString("Tech2Score", " ");
        level3 = mPref.getString("Tech3Score", " ");
        level4 = mPref.getString("Tech4Score", " ");
        level5 = mPref.getString("Tech5Score", " ");

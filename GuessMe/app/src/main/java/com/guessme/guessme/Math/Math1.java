...
//    static MediaPlayer bgmusic;
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.m1question);
        timer = (TextView) findViewById(R.id.m1Timer);
        score = (TextView) findViewById(R.id.m1score);
        questionNumber = (TextView) findViewById(R.id.m1questionNumber);

        ans1 = (Button) findViewById(R.id.m1ans1);
        ans2 = (Button) findViewById(R.id.m1ans2);
        ans3 = (Button) findViewById(R.id.m1ans3);

        csounds =MediaPlayer.create(Math1.this,R.raw.score);
...
//                        m1Score = m1Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),Math1Score.class);
...
//            bgmusic.start();
            ...
            questionNumber.setText(m1QuestionNum+1 +". ");
        ...
        questions.setText(m1Questions.getM1Questions(randomnum));
        ans1.setText(m1Questions.getM1Choice1(randomnum));
        ans2.setText(m1Questions.getM1Choice2(randomnum));
        ans3.setText(m1Questions.getM1Choice3(randomnum));

        m1Answer = m1Questions.getM1Answer(randomnum);
        m1QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Math1.this);

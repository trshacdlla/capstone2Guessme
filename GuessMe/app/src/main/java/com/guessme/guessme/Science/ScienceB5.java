...
public class ScienceB5 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.sb5question);
        timer = (TextView) findViewById(R.id.sb5Timer);
        score = (TextView) findViewById(R.id.sb5score);
        questionNumber = (TextView) findViewById(R.id.sb5questionNumber);

        ans1 = (Button) findViewById(R.id.sb5ans1);
        ans2 = (Button) findViewById(R.id.sb5ans2);
        ans3 = (Button) findViewById(R.id.sb5ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScoreB5.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getS5G1Questions(randomnum));
        ans1.setText(Questions.getS5G1Choice1(randomnum));
        ans2.setText(Questions.getS5G1Choice2(randomnum));
        ans3.setText(Questions.getS5G1Choice3(randomnum));

        Answer = Questions.getS5G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        String ins = "Identify the state of matter of the object";

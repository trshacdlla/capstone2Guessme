...
public class ScienceStatistics5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics5);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ST5barchart);
        back=(Button) findViewById(R.id.ST5back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatistics5.this);
        ...
        level5 = mPref.getString("Science5Score", " ");

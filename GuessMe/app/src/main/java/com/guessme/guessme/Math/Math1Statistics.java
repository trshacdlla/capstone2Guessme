...
public class Math1Statistics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math1_statistics);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.MT1barchart);
        back=(Button) findViewById(R.id.MT1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(Math1Statistics.this);
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Math1tries", 1);

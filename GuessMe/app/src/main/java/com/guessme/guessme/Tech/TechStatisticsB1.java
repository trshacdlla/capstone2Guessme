...
public class TechStatisticsB1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_statistics_b1);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.TTB1barchart);
        back=(Button) findViewById(R.id.TTB1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(TechStatisticsB1.this);

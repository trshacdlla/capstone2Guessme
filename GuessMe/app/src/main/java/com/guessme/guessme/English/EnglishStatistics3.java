...
public class EnglishStatistics3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_statistics3);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ET3barchart);
        back=(Button) findViewById(R.id.ET3back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishStatistics3.this);
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Engl3tries", 1);

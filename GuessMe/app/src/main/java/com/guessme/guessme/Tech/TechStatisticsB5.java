...
public class TechStatisticsB5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_statistics_b5);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.TTB5barchart);
        ...
        level1 = mPref.getString("ScienceB5Score", " ");

...
public class MathStatisticsB5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_statistics_b5);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.MTB5barchart);
        back=(Button) findViewById(R.id.MTB5back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(MathStatisticsB5.this);

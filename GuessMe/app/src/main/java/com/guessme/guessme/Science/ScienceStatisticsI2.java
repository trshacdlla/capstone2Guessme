...
public class ScienceStatisticsI2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_i2);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STI2barchart);
        back=(Button) findViewById(R.id.STI2back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsI2.this);

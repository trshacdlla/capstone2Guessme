...
public class ScienceStatisticsI1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_i1);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STI1barchart);
        back=(Button) findViewById(R.id.STI1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsI1.this);

...
public class ScienceI4 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_i4);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.si4question);
        timer = (TextView) findViewById(R.id.si4Timer);
        score = (TextView) findViewById(R.id.si4score);
        questionNumber = (TextView) findViewById(R.id.si4questionNumber);
...
//        });
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScoreI4.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getS4G2Questions(randomnum));
        ans1.setText(Questions.getS4G2Choice1(randomnum));
...
//        ans3.setText(Questions.getS4G2Choice3(randomnum));
    ...
    public void dialog(){
        String ins = "Select True if the statement is true and False if the statement is false";

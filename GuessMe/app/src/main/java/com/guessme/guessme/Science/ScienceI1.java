...
public class ScienceI1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_i1);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.si1question);
        timer = (TextView) findViewById(R.id.si1Timer);
        score = (TextView) findViewById(R.id.si1score);
        questionNumber = (TextView) findViewById(R.id.si1questionNumber);

        ans1 = (Button) findViewById(R.id.si1ans1);
        ans2 = (Button) findViewById(R.id.si1ans2);
        ans3 = (Button) findViewById(R.id.si1ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScoreI1.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getS1G2Questions(randomnum));
        ans1.setText(Questions.getS1G2Choice1(randomnum));
        ans2.setText(Questions.getS1G2Choice2(randomnum));
        ans3.setText(Questions.getS1G2Choice3(randomnum));

        Answer = Questions.getS1G2Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        String ins = "Click the letter S if the given is Solid, L for Liquid, and G for Gas. ";

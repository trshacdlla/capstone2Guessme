...
public class TechStatistics4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_statistics4);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.TT4barchart);
        back=(Button) findViewById(R.id.TT4back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(TechStatistics4.this);

...
public class EnglishStatistics5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_statistics5);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ET5barchart);
        back=(Button) findViewById(R.id.ET5back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishStatistics5.this);
        level1 = mPref.getString("Engl1Score", " ");
        level2 = mPref.getString("Engl2Score", " ");
        level3 = mPref.getString("Engl3Score", " ");
        level4 = mPref.getString("Engl4Score", " ");
        level5 = mPref.getString("Engl5Score", " ");
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Engl5tries", 1);

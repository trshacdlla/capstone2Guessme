...
public class MathStatisticsB4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_statistics_b4);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.MTB4barchart);
        back=(Button) findViewById(R.id.MTB4back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(MathStatisticsB4.this);

...
public class ScienceI5 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_i5);
    ...
    private void init(){
        ...
        ans1 = (Button) findViewById(R.id.si5ans1);
        ans2 = (Button) findViewById(R.id.si5ans2);
        ans3 = (Button) findViewById(R.id.si5ans3);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getS5G2P1Questions(randomnum));

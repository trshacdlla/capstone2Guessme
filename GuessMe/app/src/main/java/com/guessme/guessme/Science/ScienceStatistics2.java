...
public class ScienceStatistics2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics2);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ST2barchart);
        back=(Button) findViewById(R.id.ST2back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatistics2.this);

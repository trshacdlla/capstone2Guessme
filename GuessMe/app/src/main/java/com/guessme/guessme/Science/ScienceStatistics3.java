...
public class ScienceStatistics3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics3);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ST3barchart);
        back=(Button) findViewById(R.id.ST3back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatistics3.this);

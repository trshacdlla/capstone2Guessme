...
public class TechStatistics2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_statistics2);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.TT2barchart);
        back=(Button) findViewById(R.id.TT2back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(TechStatistics2.this);

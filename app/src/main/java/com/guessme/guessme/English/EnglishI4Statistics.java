...
public class EnglishI4Statistics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_i4_statistics);
        init();
        graph();
        button();
    }
    ...
    public void init(){
        ...
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishI4Statistics.this);

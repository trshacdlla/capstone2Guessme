...
public class EnglishEx5Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_ex5_statistics);
        init();
        graph();
        button();
    }
    ...
    //Initialize
    public void init() {
        barChart = (BarChart) findViewById(R.id.Ex5barchart);
        back = (Button) findViewById(R.id.Ex5back);
        congratss = getIntent().getIntExtra("congratss", 0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishEx5Statistics.this);
        level1 = mPref.getString("EngEx1Score", " ");
        level2 = mPref.getString("EngEx2Score", " ");
        level3 = mPref.getString("EngEx3Score", " ");
        level4 = mPref.getString("EngEx4Score", " ");
        level5 = mPref.getString("EngEx5Score", " ");
    ...
    public void button() {
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("EnglI5tries", 1);

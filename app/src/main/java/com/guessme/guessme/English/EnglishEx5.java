...
public class EnglishEx5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_ex5);
        dialog();
        init();
        nextQuestion();
        Buttons();
    ...
    private void init() {
        ...
        questions = (TextView) findViewById(R.id.ex5question);
        timer = (TextView) findViewById(R.id.ex5Timer);
        score = (TextView) findViewById(R.id.ex5score);
        questionNumber = (TextView) findViewById(R.id.ex5questionNumber);

        ans1 = (Button) findViewById(R.id.ex5ans1);
        ans2 = (Button) findViewById(R.id.ex5ans2);
//        ans3 = (Button) findViewById(R.id.ex4ans3);

        csounds = MediaPlayer.create(EnglishEx5.this, R.raw.score);
...
//        });
    ...
    private void nextQuestion() {
        ...
        if (randomlist.isEmpty()) {
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(), EnglishEx5Score.class);
            trials = getIntent().getIntExtra("Englx5tries", 1);
            i.putExtra("Englx5tries", trials);
...
//            bgmusic.start();
            ...
            questionNumber.setText(e1QuestionNum + 1 + "/30 ");
        ...
        questions.setText(e1Questions.getEx5Questions(randomnum));
        ans1.setText(e1Questions.getEx5Choice1(randomnum));
        ans2.setText(e1Questions.getEx5Choice2(randomnum));
//        ans3.setText(e1Questions.getEx5Choice3(randomnum));

        e1Answer = e1Questions.getEx5Answer(randomnum);
        e1QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(EnglishEx5.this);

...
public class EnglishStatistics1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_statistics1);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ET1barchart);
        back=(Button) findViewById(R.id.ET1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishStatistics1.this);
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Engl1tries", 1);

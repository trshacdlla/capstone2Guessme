...
public class EnglishStatistics2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_statistics2);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ET2barchart);
        back=(Button) findViewById(R.id.ET2back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishStatistics2.this);
        level1 = mPref.getString("Engl1Score", "0");
        level2 = mPref.getString("Engl2Score", "0");
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Engl2tries", 1);

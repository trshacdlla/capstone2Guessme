...
public class EnglishEx2Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_ex2_statistics);
        init();
        graph();
        button();
    }
    ...
    //Initialize
    public void init() {
        barChart = (BarChart) findViewById(R.id.Ex2barchart);
        back = (Button) findViewById(R.id.Ex2back);
        congratss = getIntent().getIntExtra("congratss", 0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishEx2Statistics.this);
    ...
    public void button() {
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("EnglI1tries", 1);

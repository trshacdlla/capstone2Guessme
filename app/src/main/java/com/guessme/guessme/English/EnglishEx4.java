...
public class EnglishEx4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_ex4);
        dialog();
        init();
        nextQuestion();
        Buttons();
    ...
    private void init() {
        ...
        questions = (TextView) findViewById(R.id.ex4question);
        timer = (TextView) findViewById(R.id.ex4Timer);
        score = (TextView) findViewById(R.id.ex4score);
        questionNumber = (TextView) findViewById(R.id.ex4questionNumber);

        ans1 = (Button) findViewById(R.id.ex4ans1);
        ans2 = (Button) findViewById(R.id.ex4ans2);
        ans3 = (Button) findViewById(R.id.ex4ans3);

        csounds = MediaPlayer.create(EnglishEx4.this, R.raw.score);
...
//                    e1Score = e1Score + 1;
    ...
    private void nextQuestion() {
        ...
        if (randomlist.isEmpty()) {
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(), EnglishEx4Score.class);
            trials = getIntent().getIntExtra("Englx4tries", 1);
            i.putExtra("Englx4tries", trials);
...
//            bgmusic.start();
            ...
            questionNumber.setText(e1QuestionNum + 1 + "/25 ");
        ...
        questions.setText(e1Questions.getEx4Questions(randomnum));
        ans1.setText(e1Questions.getEx4Choice1(randomnum));
        ans2.setText(e1Questions.getEx4Choice2(randomnum));
        ans3.setText(e1Questions.getEx4Choice3(randomnum));

        e1Answer = e1Questions.getEx4Answer(randomnum);
        e1QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(EnglishEx4.this);

...
public class EnglishI1Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_i1_statistics);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ETI1barchart);
        back=(Button) findViewById(R.id.ETI1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishI1Statistics.this);

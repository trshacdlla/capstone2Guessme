...
public class EnglishStatistics4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_statistics4);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ET4barchart);
        back=(Button) findViewById(R.id.ET4back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishStatistics4.this);
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Engl4tries", 1);

...
public class EnglishEx3Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_ex3_statistics);
        init();
        graph();
        button();
    }
    ...
    //Initialize
    public void init() {
        barChart = (BarChart) findViewById(R.id.Ex3barchart);
        back = (Button) findViewById(R.id.Ex3back);
        congratss = getIntent().getIntExtra("congratss", 0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishEx3Statistics.this);

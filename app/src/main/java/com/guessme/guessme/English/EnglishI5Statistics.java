...
public class EnglishI5Statistics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_i5_statistics);
        init();
        graph();
        button();
    }
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ETI4barchart);
        back=(Button) findViewById(R.id.ETI4back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(EnglishI5Statistics.this);
        level1 = mPref.getString("EnglI1Score", " ");
        level2 = mPref.getString("EnglI2Score", " ");
        level3 = mPref.getString("EnglI3Score", " ");
        level4 = mPref.getString("EnglI4Score", " ");
        level5 = mPref.getString("EnglI5Score", " ");
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), EnglishIScore5.class);

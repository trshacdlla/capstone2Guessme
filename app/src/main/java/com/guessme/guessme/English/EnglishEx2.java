...
public class EnglishEx2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_ex2);
        dialog();
        init();
        nextQuestion();
        Buttons();
    ...
    private void init() {
        ...
        questions = (TextView) findViewById(R.id.ex2question);
        timer = (TextView) findViewById(R.id.ex2Timer);
        score = (TextView) findViewById(R.id.ex2score);
        questionNumber = (TextView) findViewById(R.id.ex2questionNumber);

        ans1 = (Button) findViewById(R.id.ex2ans1);
        ans2 = (Button) findViewById(R.id.ex2ans2);
        ans3 = (Button) findViewById(R.id.ex2ans3);

        csounds = MediaPlayer.create(EnglishEx2.this, R.raw.score);
...
//                    e1Score = e1Score + 1;
    ...
    private void nextQuestion() {
        ...
        if (randomlist.isEmpty()) {
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(), EnglishEx2Score.class);
            trials = getIntent().getIntExtra("Englx2tries", 1);
            i.putExtra("Englx2tries", trials);
...
//            bgmusic.start();
            ...
            questionNumber.setText(e1QuestionNum + 1 + "/15 ");
        ...
        questions.setText(e1Questions.getEx2Questions(randomnum));
        ans1.setText(e1Questions.getEx2Choice1(randomnum));
        ans2.setText(e1Questions.getEx2Choice2(randomnum));
        ans3.setText(e1Questions.getEx2Choice3(randomnum));

        e1Answer = e1Questions.getEx2Answer(randomnum);
        e1QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(EnglishEx2.this);

...
public class EnglishI5 extends AppCompatActivity {

    private EnglishQuestions EI5question = new EnglishQuestions();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_i5);
    ...
    private void init() {
        ...
        questions = (TextView) findViewById(R.id.ei5question);
        timer = (TextView) findViewById(R.id.ei5Timer);
        score = (TextView) findViewById(R.id.ei5score);
        questionNumber = (TextView) findViewById(R.id.ei5questionNumber);
...
//            bgmusic.start();
        ...
        questions.setText(EI5question.getEI5question(randomnum));

        ans1.setText(EI5question.getEI5Choice1(randomnum));
        ans2.setText(EI5question.getEI5Choice2(randomnum));
        ans3.setText(EI5question.getEI5Choice3(randomnum));

        ei4Answer = EI5question.getEI5Answer(randomnum);
        ei4QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(EnglishI5.this);

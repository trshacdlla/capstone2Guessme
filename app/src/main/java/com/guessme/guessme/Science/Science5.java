...
public class Science5 extends AppCompatActivity {
    ...
    private ScienceQuestions s5Questions = new ScienceQuestions();
...
//    static MediaPlayer bgmusic;
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.s5question);
        timer = (TextView) findViewById(R.id.s5Timer);
        score = (TextView) findViewById(R.id.s5score);
        questionNumber = (TextView) findViewById(R.id.s5questionNumber);

        ans1 = (Button) findViewById(R.id.s5ans1);
        ans2 = (Button) findViewById(R.id.s5ans2);
        ans3 = (Button) findViewById(R.id.s5ans3);
//
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScore5.class);
...
//            bgmusic.start();
        ...
        questions.setText(s5Questions.getS5Questions(randomnum));
        ans1.setText(s5Questions.getS5Choice1(randomnum));
        ans2.setText(s5Questions.getS5Choice2(randomnum));
        ans3.setText(s5Questions.getS5Choice3(randomnum));

        Answer = s5Questions.getS5Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Science5.this);

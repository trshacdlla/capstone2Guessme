...
//            bgmusic.start();
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(ScienceB4.this);

        alertDialog.setTitle("Learning Objective:");
        alertDialog.setMessage("The children will be categorized  the animals according to their food.");

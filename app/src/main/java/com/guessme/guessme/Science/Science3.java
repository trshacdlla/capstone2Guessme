...
public class Science3 extends AppCompatActivity {
    ...
    private ScienceQuestions s3Questions = new ScienceQuestions();
...
//    static MediaPlayer bgmusic;
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.s3question);
        timer = (TextView) findViewById(R.id.s3Timer);
        score = (TextView) findViewById(R.id.s3score);
        questionNumber = (TextView) findViewById(R.id.s3questionNumber);

        ans1 = (Button) findViewById(R.id.s3ans1);
        ans2 = (Button) findViewById(R.id.s3ans2);
//        ans3 = (Button) findViewById(R.id.s3ans3);
...
//        });
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScore3.class);
...
//            bgmusic.start();
        ...
        questions.setText(s3Questions.getS3Questions(randomnum));
        ans1.setText(s3Questions.getS3Choice1(randomnum));
        ans2.setText(s3Questions.getS3Choice2(randomnum));
//        ans3.setText(s3Questions.getS3Choice3(randomnum));

        Answer = s3Questions.getS3Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Science3.this);

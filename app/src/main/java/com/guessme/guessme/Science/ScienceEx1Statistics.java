...
public class ScienceEx1Statistics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_ex1_statistics);
        init();
        graph();
        button();
    }
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.Sx1barchart);
        back=(Button) findViewById(R.id.Sx1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceEx1Statistics.this);
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), ScienceEx1Score.class);

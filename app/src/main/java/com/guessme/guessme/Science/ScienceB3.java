...
public class ScienceB3 extends AppCompatActivity {
...
//    static MediaPlayer quiz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_b3);
//        quiz = MediaPlayer.create(ScienceB3.this, R.raw.quiz);
//        quiz.start();
        init();
        dialog();
        nextQuestion();
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.sb3question);
        timer = (TextView) findViewById(R.id.sb3Timer);
        score = (TextView) findViewById(R.id.sb3score);
        questionNumber = (TextView) findViewById(R.id.sb3questionNumber);

        ans1 = (Button) findViewById(R.id.sb3ans1);
        ans2 = (Button) findViewById(R.id.sb3ans2);
//        ans3 = (Button) findViewById(R.id.sb3ans3);
...
//        });
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScoreB3.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getS3G1Questions(randomnum));
        ans1.setText(Questions.getS3G1Choice1(randomnum));
        ans2.setText(Questions.getS3G1Choice2(randomnum));
//        ans3.setText(Questions.getS3G1Choice3(randomnum));

        Answer = Questions.getS3G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(ScienceB3.this);

        alertDialog.setTitle("Learning Objective:");
        alertDialog.setMessage("Children will be able to classify objects as living and nonliving.");

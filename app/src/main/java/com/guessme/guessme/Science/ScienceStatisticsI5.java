...
public class ScienceStatisticsI5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_i5);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STI5barchart);
        back=(Button) findViewById(R.id.STI5back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsI5.this);
        level5 = mPref.getString("ScienceI5Score", " ");
        level4 = mPref.getString("ScienceI4Score", " ");
        level1 = mPref.getString("ScienceI1Score", " ");
        level2 = mPref.getString("ScienceI2Score", " ");
        level3 = mPref.getString("ScienceI3Score", " ");
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), ScienceScoreI5.class);

...
public class ScienceStatisticsI3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_i3);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STI3barchart);
        back=(Button) findViewById(R.id.STI3back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsI3.this);

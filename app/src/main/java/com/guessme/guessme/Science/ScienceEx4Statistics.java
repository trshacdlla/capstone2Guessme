...
public class ScienceEx4Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.Sx4barchart);
        back=(Button) findViewById(R.id.Sx4back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceEx4Statistics.this);

...
public class ScienceStatisticsB2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_b2);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STB2barchart);
        back=(Button) findViewById(R.id.STB2back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsB2.this);

...
//    static MediaPlayer bgmusic;
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.s4question);
        timer = (TextView) findViewById(R.id.s4Timer);
        score = (TextView) findViewById(R.id.s4score);
        questionNumber = (TextView) findViewById(R.id.s4questionNumber);

        ans1 = (Button) findViewById(R.id.s4ans1);
        ans2 = (Button) findViewById(R.id.s4ans2);
//        ans3 = (Button) findViewById(R.id.s4ans3);
...
//        ans3.setText(s3Questions.getS3Choice3(randomnum));
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Science4.this);

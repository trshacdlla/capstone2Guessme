...
public class ScienceEx4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_ex4);
        init();
        dialog();
//        startTimer();
        Buttons();
    ...
    private void init() {
        ...
        questions = (TextView) findViewById(R.id.sx4question);
        timer = (TextView) findViewById(R.id.sx4Timer);
        score = (TextView) findViewById(R.id.sx4score);
        questionNumber = (TextView) findViewById(R.id.sx4questionNumber);

        ans1 = (Button) findViewById(R.id.sx4ans1);
        ans2 = (Button) findViewById(R.id.sx4ans2);
...
//        });
    ...
    private void nextQuestion() {
        ...
        if (randomlist.isEmpty()) {
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(), ScienceEx4Score.class);
        ...
        questions.setText(Questions.getEx4Questions(randomnum));
        ans1.setText(Questions.getEx4Choice1(randomnum));
        ans2.setText(Questions.getEx4Choice2(randomnum));
//        ans3.setText(Questions.getEx4Choice3(randomnum));

        Answer = Questions.getEx4Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog() {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(ScienceEx4.this);

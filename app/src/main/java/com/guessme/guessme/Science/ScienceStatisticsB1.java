...
public class ScienceStatisticsB1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_b1);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STB1barchart);
        back=(Button) findViewById(R.id.STB1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsB1.this);

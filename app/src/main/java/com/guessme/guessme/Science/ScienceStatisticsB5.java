...
public class ScienceStatisticsB5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_b5);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STB5barchart);
        back=(Button) findViewById(R.id.STB5back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsB5.this);
        level5 = mPref.getString("ScienceB5Score", " ");
        level4 = mPref.getString("ScienceB4Score", " ");
        level3 = mPref.getString("ScienceB3Score", " ");
        level1 = mPref.getString("ScienceB1Score", " ");
        level2 = mPref.getString("ScienceB2Score", " ");

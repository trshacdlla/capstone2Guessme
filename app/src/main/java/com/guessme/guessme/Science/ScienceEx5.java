...
public class ScienceEx5 extends AppCompatActivity {
...
//        startTimer();
    ...
    private void init() {
        ...
        questions = (TextView) findViewById(R.id.sx5question);
        timer = (TextView) findViewById(R.id.sx5Timer);
        score = (TextView) findViewById(R.id.sx5score);
        questionNumber = (TextView) findViewById(R.id.sx5questionNumber);

        ans1 = (Button) findViewById(R.id.sx5ans1);
        ans2 = (Button) findViewById(R.id.sx5ans2);
...
//        });
    ...
    private void nextQuestion() {
        ...
        questions.setText(Questions.getEx5Questions(randomnum));
        ans1.setText(Questions.getEx5Choice1(randomnum));
        ans2.setText(Questions.getEx5Choice2(randomnum));
//        ans3.setText(Questions.getEx2Choice3(randomnum));

        Answer = Questions.getEx5Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog() {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(ScienceEx5.this);

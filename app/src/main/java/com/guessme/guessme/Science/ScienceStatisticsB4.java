...
public class ScienceStatisticsB4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_b4);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STB4barchart);
        back=(Button) findViewById(R.id.STB4back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsB4.this);

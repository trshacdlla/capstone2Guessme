...
public class ScienceStatistics1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics1);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ST1barchart);
        back=(Button) findViewById(R.id.ST1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatistics1.this);

...
public class ScienceEx3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_ex3);
        init();
        dialog();
//        startTimer();
        Buttons();
    ...
    private void init() {
        ...
        questions = (TextView) findViewById(R.id.sx3question);
        timer = (TextView) findViewById(R.id.sx3Timer);
        score = (TextView) findViewById(R.id.sx3score);
        questionNumber = (TextView) findViewById(R.id.sx3questionNumber);

        ans1 = (Button) findViewById(R.id.sx3ans1);
        ans2 = (Button) findViewById(R.id.sx3ans2);
...
//        });
    ...
    private void nextQuestion() {
        ...
        if (randomlist.isEmpty()) {
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(), ScienceEx3Score.class);
        ...
        questions.setText(Questions.getEx3Questions(randomnum));
        ans1.setText(Questions.getEx3Choice1(randomnum));
        ans2.setText(Questions.getEx3Choice2(randomnum));
//        ans3.setText(Questions.getEx3Choice3(randomnum));

        Answer = Questions.getEx3Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog() {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(ScienceEx3.this);

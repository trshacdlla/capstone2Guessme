...
public class ScienceI2 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_i2);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.si2question);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScoreI2.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getS2G2Questions(randomnum));
        ans1.setText(Questions.getS2G2Choice1(randomnum));
        ans2.setText(Questions.getS2G2Choice2(randomnum));
        ans3.setText(Questions.getS2G2Choice3(randomnum));

        Answer = Questions.getS2G2Answer(randomnum);
        QuestionNum++;

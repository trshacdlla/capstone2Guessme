...
public class ScienceStatisticsB3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_statistics_b3);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.STB3barchart);
        back=(Button) findViewById(R.id.STB3back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(ScienceStatisticsB3.this);

...
public class Science2 extends AppCompatActivity {
    ...
    private ScienceQuestions s2Questions = new ScienceQuestions();
...
//    static MediaPlayer bgmusic;
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.s2question);
        timer = (TextView) findViewById(R.id.s2Timer);
        score = (TextView) findViewById(R.id.s2score);
        questionNumber = (TextView) findViewById(R.id.s2questionNumber);

        ans1 = (Button) findViewById(R.id.s2ans1);
        ans2 = (Button) findViewById(R.id.s2ans2);
        ans3 = (Button) findViewById(R.id.s2ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),ScienceScore2.class);
...
//            bgmusic.start();
        ...
        questions.setText(s2Questions.getS2Questions(randomnum));
        ans1.setText(s2Questions.getS2Choice1(randomnum));
        ans2.setText(s2Questions.getS2Choice2(randomnum));
        ans3.setText(s2Questions.getS2Choice3(randomnum));

        Answer = s2Questions.getS2Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Science2.this);

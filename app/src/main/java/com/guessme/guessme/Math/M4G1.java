...
public class M4G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_b4);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.mb4question);
        timer = (TextView) findViewById(R.id.mb4Timer);
        score = (TextView) findViewById(R.id.mb4score);
        questionNumber = (TextView) findViewById(R.id.mb4questionNumber);

        ans1 = (Button) findViewById(R.id.mb4ans1);
        ans2 = (Button) findViewById(R.id.mb4ans2);
        ans3 = (Button) findViewById(R.id.mb4ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),MathScoreB4.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getM4G1Questions(randomnum));
        ans1.setText(Questions.getM4G1Choice1(randomnum));
        ans2.setText(Questions.getM4G1Choice2(randomnum));
        ans3.setText(Questions.getM4G1Choice3(randomnum));

        Answer = Questions.getM4G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(M4G1.this);

        alertDialog.setTitle("Learning objective:");
        alertDialog.setMessage("The children are expected to learn how to add  two digit numbers.\n");

...
public class M1G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_b1);
    ...
    private void init(){
        ...
        questions = (ImageView) findViewById(R.id.mb1question);
        timer = (TextView) findViewById(R.id.mb1Timer);
        score = (TextView) findViewById(R.id.mb1score);
        questionNumber = (TextView) findViewById(R.id.mb1questionNumber);

        ans1 = (Button) findViewById(R.id.mb1ans1);
        ans2 = (Button) findViewById(R.id.mb1ans2);
        ans3 = (Button) findViewById(R.id.mb1ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),MathScoreB1.class);
...
//            bgmusic.start();
            ...
            questionNumber.setText(QuestionNum+1 +"/10");
        ...
        questions.setImageResource(Questions.getM1G1Questions(randomnum));
        ans1.setText(Questions.getM1G1Choice1(randomnum));
        ans2.setText(Questions.getM1G1Choice2(randomnum));
        ans3.setText(Questions.getM1G1Choice3(randomnum));

        Answer = Questions.getM1G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(M1G1.this);

...
public class MathE2Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_e2_statistics);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ME2barchart);
        back=(Button) findViewById(R.id.ME2back);
        congratss = getIntent().getIntExtra("congrats",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(MathE2Statistics.this);

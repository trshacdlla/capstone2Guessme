...
public class MathE5Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_e5_statistics);
        init();
        graph();
        button();
    }
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ME5barchart);
        back=(Button) findViewById(R.id.ME5back);
        congratss = getIntent().getIntExtra("congrats",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(MathE5Statistics.this);
        ...
        level5 = mPref.getString("MathE5Score", " ");

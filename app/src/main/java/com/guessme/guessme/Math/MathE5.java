...
public class MathE5 extends AppCompatActivity {
    private MathQuestions Questions = new MathQuestions();
    private ArrayList<Integer> randomlist = new ArrayList<>();

    static MediaPlayer csounds;

    private TextView timer,score,questionNumber,qnumber,questions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_e5);
        init();
        dialog();
        nextQuestion();
        Buttons();
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.me5question);
        timer = (TextView) findViewById(R.id.me5Timer);
        score = (TextView) findViewById(R.id.me5score);
        questionNumber = (TextView) findViewById(R.id.me5questionNumber);

        ans1 = (Button) findViewById(R.id.me5ans1);
        ans2 = (Button) findViewById(R.id.me5ans2);
        ans3 = (Button) findViewById(R.id.me5ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),MathE5Score.class);
...
//            bgmusic.start();
            ...
            questionNumber.setText(QuestionNum+1 +"/30");
        ...
        questions.setText(Questions.getME5Questions(randomnum));
        ans1.setText(Questions.getME5Choice1(randomnum));
        ans2.setText(Questions.getME5Choice2(randomnum));
        ans3.setText(Questions.getME5Choice3(randomnum));

        Answer = Questions.getME5Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(MathE5.this);

        alertDialog.setTitle("Directions:");
        alertDialog.setMessage("Choose the correct Hindu arabic numbers of each Roman numerals");

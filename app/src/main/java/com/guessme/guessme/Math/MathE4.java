...
public class MathE4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_e4);
        init();
        dialog();
        nextQuestion();
        Buttons();
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.me4question);
        timer = (TextView) findViewById(R.id.me4Timer);
        score = (TextView) findViewById(R.id.me4score);
        questionNumber = (TextView) findViewById(R.id.me4questionNumber);

        ans1 = (Button) findViewById(R.id.me4ans1);
        ans2 = (Button) findViewById(R.id.me4ans2);
        ans3 = (Button) findViewById(R.id.me4ans3);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getME4Questions(randomnum));
        ans1.setText(Questions.getME4Choice1(randomnum));
        ans2.setText(Questions.getME4Choice2(randomnum));
        ans3.setText(Questions.getME4Choice3(randomnum));

        Answer = Questions.getME4Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(MathE4.this);

...
public class MathE3Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_e3_statistics);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ME3barchart);
        back=(Button) findViewById(R.id.ME3back);
        congratss = getIntent().getIntExtra("congrats",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(MathE3Statistics.this);

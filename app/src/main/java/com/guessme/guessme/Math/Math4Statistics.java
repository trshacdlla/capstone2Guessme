...
public class Math4Statistics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math4_statistics);
    ...
    public void init(){
        barChart=(BarChart) findViewById(R.id.MT4barchart);
        back=(Button) findViewById(R.id.MT4back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(Math4Statistics.this);
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Math4tries", 1);

...
public class M5G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_b5);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.mb5question);
        timer = (TextView) findViewById(R.id.mb5Timer);
        score = (TextView) findViewById(R.id.mb5score);
        questionNumber = (TextView) findViewById(R.id.mb5questionNumber);

        ans1 = (Button) findViewById(R.id.mb5ans1);
        ans2 = (Button) findViewById(R.id.mb5ans2);
        ans3 = (Button) findViewById(R.id.mb5ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),MathScoreB5.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getM5G1Questions(randomnum));
        ans1.setText(Questions.getM5G1Choice1(randomnum));
        ans2.setText(Questions.getM5G1Choice2(randomnum));
        ans3.setText(Questions.getM5G1Choice3(randomnum));
        if (ans3.getText().toString().equals(" ")){
            ans3.setVisibility(View.INVISIBLE);
        }else{

        }
        Answer = Questions.getM5G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(M5G1.this);

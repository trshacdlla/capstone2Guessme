...
public class MathE3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_e3);
        init();
        dialog();
        nextQuestion();
        Buttons();
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.me3question);
        timer = (TextView) findViewById(R.id.me3Timer);
        score = (TextView) findViewById(R.id.me3score);
        questionNumber = (TextView) findViewById(R.id.me3questionNumber);

        ans1 = (Button) findViewById(R.id.me3ans1);
        ans2 = (Button) findViewById(R.id.me3ans2);
        ans3 = (Button) findViewById(R.id.me3ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),MathE3Score.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getME3Questions(randomnum));
        ans1.setText(Questions.getME3Choice1(randomnum));
        ans2.setText(Questions.getME2Choice2(randomnum));
        ans3.setText(Questions.getME2Choice3(randomnum));

        Answer = Questions.getME3Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(MathE3.this);

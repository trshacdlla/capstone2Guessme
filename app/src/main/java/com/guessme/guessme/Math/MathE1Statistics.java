...
public class MathE1Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_e1_statistics);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.ME1barchart);
        back=(Button) findViewById(R.id.ME1back);
        congratss = getIntent().getIntExtra("congrats",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(MathE1Statistics.this);

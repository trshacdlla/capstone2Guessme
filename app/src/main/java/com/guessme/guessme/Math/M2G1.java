...
public class M2G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_b2);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.mb2question);
        timer = (TextView) findViewById(R.id.mb2Timer);
        score = (TextView) findViewById(R.id.mb2score);
        questionNumber = (TextView) findViewById(R.id.mb2questionNumber);

        ans1 = (Button) findViewById(R.id.mb2ans1);
        ans2 = (Button) findViewById(R.id.mb2ans2);
//        ans3 = (Button) findViewById(R.id.mb2ans3);
...
//        });
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),MathScoreB2.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getM2G1Questions(randomnum));
        ans1.setText(Questions.getM2G1Choice1(randomnum));
        ans2.setText(Questions.getM2G1Choice2(randomnum));
    //    ans3.setText(Questions.getM2G1Choice3(randomnum));

        Answer = Questions.getM2G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(M2G1.this);

        alertDialog.setTitle("Learning objective:");
        alertDialog.setMessage("To know how to compare numbers using greater than (>) and less than (<)");

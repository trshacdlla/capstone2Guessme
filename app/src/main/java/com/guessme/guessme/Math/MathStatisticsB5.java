...
public class MathStatisticsB5 extends AppCompatActivity {
    ...
    public void init(){
        ...
        level5 = mPref.getString("MathB5Score", " ");
        level1 = mPref.getString("MathB1Score", " ");
        level2 = mPref.getString("MathB2Score", " ");
        level3 = mPref.getString("MathB3Score", " ");
        level4 = mPref.getString("MathB4Score", " ");

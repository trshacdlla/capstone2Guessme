...
public class T3G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_b3);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.tb3question);
        timer = (TextView) findViewById(R.id.tb3Timer);
        score = (TextView) findViewById(R.id.tb3score);
        questionNumber = (TextView) findViewById(R.id.tb3questionNumber);

        ans1 = (Button) findViewById(R.id.tb3ans1);
        ans2 = (Button) findViewById(R.id.tb3ans2);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getT3G1Questions(randomnum));
        ans1.setText(Questions.getT3G1Choice1(randomnum));
        ans2.setText(Questions.getT3G1Choice2(randomnum));
//        ans3.setText(Questions.getS3G1Choice3(randomnum));

        Answer = Questions.getT3G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(T3G1.this);

        alertDialog.setTitle("Learning objective:");
        alertDialog.setMessage("The children will know how to properly handle their computer");

...
public class TechEx2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_ex2);
        init();
        dialog();
        nextQuestion();
        Buttons();
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.tx2question);
        timer = (TextView) findViewById(R.id.tx2Timer);
        score = (TextView) findViewById(R.id.tx2score);
        questionNumber = (TextView) findViewById(R.id.tx2questionNumber);

        ans1 = (Button) findViewById(R.id.tx2ans1);
        ans2 = (Button) findViewById(R.id.tx2ans2);
        ans3 = (Button) findViewById(R.id.tx2ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),TechEx2Score.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getTex2Questions(randomnum));
        ans1.setText(Questions.getTex2Choice1(randomnum));
        ans2.setText(Questions.getTex2Choice2(randomnum));
        ans3.setText(Questions.getTex2Choice3(randomnum));

        Answer = Questions.getTex2Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(TechEx2.this);

...
public class TechEx5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_ex5);
        init();
        dialog();
        nextQuestion();
        Buttons();
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.tx5question);
        timer = (TextView) findViewById(R.id.tx5Timer);
        score = (TextView) findViewById(R.id.tx5score);
        questionNumber = (TextView) findViewById(R.id.tx5questionNumber);

        ans1 = (Button) findViewById(R.id.tx5ans1);
        ans2 = (Button) findViewById(R.id.tx5ans2);
        ans3 = (Button) findViewById(R.id.tx5ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),TechEx5Score.class);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getTex5Questions(randomnum));
        ans1.setText(Questions.getTex5Choice1(randomnum));
        ans2.setText(Questions.getTex5Choice2(randomnum));
        ans3.setText(Questions.getTex5Choice3(randomnum));

        Answer = Questions.getTex5Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(TechEx5.this);

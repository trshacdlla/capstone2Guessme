...
public class TechStatistics1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_statistics1);
    ...
    public void init(){
        ...
        back=(Button) findViewById(R.id.TT1back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(TechStatistics1.this);

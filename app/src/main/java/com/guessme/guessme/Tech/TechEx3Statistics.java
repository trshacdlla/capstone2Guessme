...
public class TechEx3Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_ex3_statistics);
        init();
        graph();
        button();
    }
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.Tx3barchart);
        back=(Button) findViewById(R.id.Tx3back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(TechEx3Statistics.this);
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Tech3tries", 1);

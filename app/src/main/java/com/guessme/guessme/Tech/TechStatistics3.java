...
public class TechStatistics3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_statistics3);
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.TT3barchart);
        back=(Button) findViewById(R.id.TT3back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(TechStatistics3.this);

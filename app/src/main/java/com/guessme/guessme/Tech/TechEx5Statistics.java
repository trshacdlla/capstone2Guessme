...
public class TechEx5Statistics extends AppCompatActivity {
    BarChart barChart;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_ex5_statistics);
        init();
        graph();
        button();
    }
    ...
    //Initialize
    public void init(){
        barChart=(BarChart) findViewById(R.id.Tx5barchart);
        back=(Button) findViewById(R.id.Tx5back);
        congratss = getIntent().getIntExtra("congratss",0);
        SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(TechEx5Statistics.this);
        level1 = mPref.getString("TechEx1Score", " ");
        level2 = mPref.getString("TechEx2Score", " ");
        level3 = mPref.getString("TechEx3Score", " ");
        level4 = mPref.getString("TechEx4Score", " ");
        level5 = mPref.getString("TechEx5Score", " ");
    ...
    public void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int trials = getIntent().getIntExtra("Tech5tries", 1);

...
public class T5G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_b5);
    ...
    private void init(){
        ...
        questions = (ImageView) findViewById(R.id.tb5question);
        timer = (TextView) findViewById(R.id.tb5Timer);
        score = (TextView) findViewById(R.id.tb5score);
        questionNumber = (TextView) findViewById(R.id.tb5questionNumber);

        ans1 = (Button) findViewById(R.id.tb5ans1);
        ans2 = (Button) findViewById(R.id.tb5ans2);
        ans3 = (Button) findViewById(R.id.tb5ans3);
...
//            bgmusic.start();
        ...
        questions.setImageResource(Questions.getT5G1Questions(randomnum));
        ans1.setText(Questions.getT5G1Choice1(randomnum));
        ans2.setText(Questions.getT5G1Choice2(randomnum));
        ans3.setText(Questions.getT5G1Choice3(randomnum));

        Answer = Questions.getT5G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(T5G1.this);

        alertDialog.setTitle("Learning objective:");
        alertDialog.setMessage("The children will become familiarized to the different types of softwares that can be used everyday.");

...
public class T2G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_b2);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.tb2question);
        timer = (TextView) findViewById(R.id.tb2Timer);
        score = (TextView) findViewById(R.id.tb2score);
        questionNumber = (TextView) findViewById(R.id.tb2questionNumber);

        ans1 = (Button) findViewById(R.id.tb2ans1);
        ans2 = (Button) findViewById(R.id.tb2ans2);
        ans3 = (Button) findViewById(R.id.tb2ans3);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getT2G1Questions(randomnum));
        ans1.setText(Questions.getT2G1Choice1(randomnum));
        ans2.setText(Questions.getT2G1Choice2(randomnum));
        ans3.setText(Questions.getT2G1Choice3(randomnum));

        Answer = Questions.getT2G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(T2G1.this);

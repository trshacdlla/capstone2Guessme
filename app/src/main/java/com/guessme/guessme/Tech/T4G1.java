...
public class T4G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_b4);
    ...
    private void init(){
        ...
        questions = (TextView) findViewById(R.id.tb4question);
        timer = (TextView) findViewById(R.id.tb4Timer);
        score = (TextView) findViewById(R.id.tb4score);
        questionNumber = (TextView) findViewById(R.id.tb4questionNumber);

        ans1 = (Button) findViewById(R.id.tb4ans1);
        ans2 = (Button) findViewById(R.id.tb4ans2);
        ans3 = (Button) findViewById(R.id.tb4ans3);
...
//            bgmusic.start();
        ...
        questions.setText(Questions.getT4G1Questions(randomnum));
        ans1.setText(Questions.getT4G1Choice1(randomnum));
        ans2.setText(Questions.getT4G1Choice2(randomnum));
        ans3.setText(Questions.getT4G1Choice3(randomnum));

        Answer = Questions.getT4G1Answer(randomnum);
        QuestionNum++;
    ...
    public void dialog(){
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(T4G1.this);

        alertDialog.setTitle("Learning objective:");
        alertDialog.setMessage("By the end of this level, the children will be familiarized to the basic keys of the keyboard");

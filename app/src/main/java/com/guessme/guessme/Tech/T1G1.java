...
public class T1G1 extends AppCompatActivity {
...
//    static MediaPlayer bgmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_b1);
    ...
    private void init(){
        ...
        questions = (ImageView) findViewById(R.id.tb1question);
        timer = (TextView) findViewById(R.id.tb1Timer);
        score = (TextView) findViewById(R.id.tb1score);
        questionNumber = (TextView) findViewById(R.id.tb1questionNumber);

        ans1 = (Button) findViewById(R.id.tb1ans1);
        ans2 = (Button) findViewById(R.id.tb1ans2);
        ans3 = (Button) findViewById(R.id.tb1ans3);
...
//                    Score = Score + 1;
    ...
    private void nextQuestion(){
        ...
        if (randomlist.isEmpty()){
            CountDownTimer.cancel();
            Intent i = new Intent(getApplicationContext(),TechScoreB1.class);
...
//            bgmusic.start();
        ...
        questions.setImageResource(Questions.getT1G1Questions(randomnum));
        ans1.setText(Questions.getT1G1Choice1(randomnum));
        ans2.setText(Questions.getT1G1Choice2(randomnum));
        ans3.setText(Questions.getT1G1Choice3(randomnum));

        Answer = Questions.getT1G1Answer(randomnum);
        QuestionNum++;
